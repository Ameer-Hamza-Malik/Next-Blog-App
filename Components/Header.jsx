  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
        ...
        <div className='text-center my-8'>
          ...
          <p className='mt-10 max-w-[740px]m-auto text-xs sm:text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos, impedit voluptate deserunt quisquam iure et! Consectetur repudiandae molestiae vel cumque laboriosam corrupti est natus eveniet recusandae, a, voluptas eligendi? Repudiandae!</p>
